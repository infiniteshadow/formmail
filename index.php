<?php
    if(isset($_POST['submit'])){
        ...
        $mail->SMTPAuth=true;
        $mail->SMTPSecure='tls';
        $mail->Username='kanikamugrai1711@gmail.com';
        $mail->Password='fuckacnes101!';

        $mail->setFrom($_POST['email'],$_POST['name']);
        $mail->addAddress('mugraikanika25@gmail.com');
        $mail->addReplyTo($_POST['email'],$_POST['name']);

        $mail->isHTML(true);
        $mail->Subject='Form Submission: ' .$_POST['subject'];
        $mail->Body='<h1 align=cener>Name:' .$_POST['name'].'<br>Email: ' .$_POST['email'].'<br>
